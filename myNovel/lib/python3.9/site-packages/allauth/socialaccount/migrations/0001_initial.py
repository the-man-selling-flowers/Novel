        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('provider', models.CharField(choices=[],
                 max_length=30, verbose_name='provider')),
                ...
                ('extra_data', allauth.socialaccount.fields.JSONField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client_id', models.CharField(
                    help_text='App ID, or consumer key', max_length=191, verbose_name='client id')),
                ('secret', models.CharField(blank=True, help_text='API secret, client secret, or consumer secret',
                 max_length=191, verbose_name='secret key')),
                ('key', models.CharField(blank=True, help_text='Key',
                 max_length=191, verbose_name='key')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('token_secret', models.TextField(
                    blank=True, help_text='"oauth_token_secret" (OAuth1) or refresh token (OAuth2)', verbose_name='token secret')),
                ...
                ('app', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='socialaccount.socialapp')),
            ],
            options={
